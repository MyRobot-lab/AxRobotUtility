...
esc.pSet('p2',['joint',   0,   0,   0,   degEnd,   0,  0,   0])   #**p2=起點
esc.pSet('p3',['joint',   0,   0,   0,   -degEnd,   0, -0,   0])   #**p3=終點
...
jS='4'; jN=4; print("joint=",jN)                 #**設置軸號
                                       ...
                                       #**限制恢復速度
#esc.segR("drvSPD",["",500,500,500,500,500,500,500])
esc.putR("almMSK",0x10);               #**almMSK=0x3f
esc.putR("almENB",1);                  #**almENB=0,   取消警報處理
